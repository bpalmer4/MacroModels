...
Usage::
    ...
    uv run python -m src.models.ystar.sigma_sweep
...
def run_sweep(
    ...
    for value in values:
        ...
        prefix = f"ystar_sweep_{param}_{value:g}"
        print(f"\n{'=' * 70}\n{param} = {value:g}\n{'=' * 70}")
...
def main() -> None:
    """CLI entry point."""
    parser = argparse.ArgumentParser(description="Sweep ystar variance settings")
    parser.add_argument(
