...
Gathers u* specifications from `ustar` and `ystar_ustar` and charts them
...
from src.models.ustar_summary.sources import SOURCES, gather, load_unemployment
...
def main(
    *,
    ...
    print("=" * 70)
    print(f"U* SUMMARY [{len(SOURCES)} specifications from two models]")
    print("=" * 70)
